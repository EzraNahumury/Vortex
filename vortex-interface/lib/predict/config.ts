/**
 * DeepBook Predict + Vortex PLP/Hedge vault configuration.
 *
...
export const predictConfig = {
  ...
  // Vortex PLP+Hedge vault (our package)
  vaultPackageId:
    process.env.NEXT_PUBLIC_VAULT_PACKAGE_ID ||
    "0x185d97299f82a6380e99779eaed8a51833dada528c05b39e3f537eb01a266e83",
  vaultId:
    process.env.NEXT_PUBLIC_VAULT_ID ||
    "0xa45ebd4f8c87d7c3d1e4cfe20adb4de9594aa5439bb703685facc7bb7c1314f3",
  managerId:
    process.env.NEXT_PUBLIC_VAULT_MANAGER_ID ||
    "0xd38f54d9dbeba98121e81ab39fddd559e2b63577ceecf5404a1e63ad90c9b0fb",
