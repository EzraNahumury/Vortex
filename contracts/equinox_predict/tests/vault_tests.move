#[test_only]
module equinox_predict::vault_tests {
    use sui::test_scenario as ts;
    use sui::test_utils;
    use sui::coin::{Self, TreasuryCap};
    use sui::sui::SUI;

    use equinox_predict::vault::{Self, PredictVault};
    use equinox_predict::vault_share::{Self, VAULT_SHARE};
    ...
    #[test]
    #[expected_failure(abort_code = 3, location = equinox_predict::vault)]
