/// Tokenized share for the Equinox PLP+Hedge vault.
///
...
module equinox_predict::vault_share {
    use sui::coin;
    ...
    fun init(witness: VAULT_SHARE, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            b"EPV",
            b"Equinox Predict Vault",
            b"Tokenized share of the Equinox PLP+Hedge vault on DeepBook Predict",
            option::none(),
            ctx,
        );
